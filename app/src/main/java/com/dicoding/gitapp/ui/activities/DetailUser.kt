...
import com.dicoding.gitapp.ui.adapter.AdapterPager
...
class DetailUser : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        onGetData(username)
        val adapterPagerDetails = AdapterPager(this)
    ...
    private fun onGetData(username: String?) {
        ...
        com.dicoding.gitapp.api.Retrofit.userRepositories().getDetailUser(username.toString()).enqueue(object : Callback<DataUser>{
